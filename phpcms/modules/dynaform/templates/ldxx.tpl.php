...
if(is_array($infos)){
	...
	<tr>
		...
		<td align="center" width="100"> <a
			href='?m=dynaform&c=dynaform&a=delete_ldxx&mailid=<?php echo $info['id']?>'
...
<input name="dosubmit" type="submit" class="button"
	value="<?php echo L('listorder')?>">&nbsp;&nbsp;<input type="submit" class="button" name="dosubmit" onClick="document.myform.action='?m=dynaform&c=dynaform&a=delete_ldxx'" value="<?php echo L('delete')?>"/></div>
